...
def _3d_card(contents,theme=None,padding="20px"):
    ...
    return {
        ...
        "backgroundColor":c["card"],"cornerRadius":"16px","paddingAll":padding,
        "borderWidth":"1px","borderColor":c["border"],"margin":"md",
        "offsetTop":"0px","offsetStart":"0px","offsetEnd":"0px","offsetBottom":"4px",
...
def _gradient_header(text,theme=None):
    ...
    return {
        ...
        "contents":[{
            "type":"text","text":text,"size":"xxl","weight":"bold",
            "color":c["primary"],"align":"center","gravity":"center"
        }],
        "height":"60px","backgroundColor":c["card"],"cornerRadius":"16px",
        "borderWidth":"1px","borderColor":c["border"],"paddingAll":"md","offsetBottom":"4px"
    }
...
def _premium_button(label,text,style="primary",theme=None):
    ...
    return {
        ...
        "contents":[{
            ...
            "color":c["button_text"],"align":"center","gravity":"center"
        }],
        "backgroundColor":btn_color,"cornerRadius":"12px","paddingAll":"12px",
        "action":{"type":"message","text":text},"height":"44px","offsetBottom":"3px",
        "borderWidth":"1px","borderColor":btn_color
    }
...
def _stat_box(label,value,color_key="primary",theme=None):
    ...
    return {
        ...
        "backgroundColor":c["card"],"cornerRadius":"16px","paddingAll":"16px",
        "borderWidth":"1px","borderColor":c["border"],"flex":1,"offsetBottom":"4px"
    }
    ...
    body={
        ...
        "body":{
            ...
            "contents":[
                ...
                {"type":"text","text":"يمكنك استخدام البوت في الخاص أو المجموعات","size":"xs","color":c["text2"],"align":"center","margin":"xs"},
                _separator_3d(theme),
                _3d_card([
                    {"type":"box","layout":"horizontal","contents":[
                        {"type":"box","layout":"vertical","contents":[
                            {"type":"text","text":username[:30],"size":"lg","weight":"bold","color":c["text"],"wrap":True},
                            {"type":"text","text":status,"size":"sm","color":status_color,"margin":"xs"}
                        ],"flex":1}
                    ]},
                    {"type":"separator","margin":"md","color":c["border"]},
                    {"type":"box","layout":"horizontal","contents":[
                        {"type":"text","text":"النقاط","size":"md","color":c["text2"],"flex":1},
                        {"type":"text","text":str(points),"size":"xxl","weight":"bold","color":c["primary"],"flex":0}
                    ],"margin":"md"}
                ],theme,"18px"),
...
def build_games_menu(theme=DEFAULT_THEME,top_games=None):
    c=_c(theme)
    default_order=["أسرع","ذكاء","لعبة","خمن","أغنيه","سلسلة","ترتيب","تكوين","ضد","لون","رياضيات","توافق"]
    ...
    body={
        ...
        "body":{
            "type":"box","layout":"vertical",
            "contents":[
                _gradient_header("الألعاب",theme),
                {"type":"text","text":"مرتبة حسب الأكثر استخداماً","size":"xs","color":c["text3"],"align":"center","margin":"sm"},
                _separator_3d(theme),
                *game_buttons,
                _3d_card([
                    {"type":"text","text":"أوامر اللعب","size":"sm","weight":"bold","color":c["text"],"align":"center"},
                    {"type":"text","text":"اضغط اسم اللعبة • لمح • جاوب • إيقاف","size":"xs","color":c["text2"],"wrap":True,"margin":"sm","align":"center"}
                ],theme,"14px"),
                {"type":"box","layout":"horizontal","spacing":"sm","margin":"lg","contents":[
        ...
        "body":{
            ...
            "contents":[
                ...
                {"type":"box","layout":"vertical","contents":[
                    {"type":"box","layout":"horizontal","contents":[
                        {"type":"box","layout":"vertical","contents":[
                            {"type":"text","text":"●","size":"xl","color":c["primary"],"weight":"bold"}
                        ],"flex":0,"gravity":"center","paddingEnd":"md"},
                        {"type":"box","layout":"vertical","contents":[
                            {"type":"text","text":"بدء اللعب","size":"sm","weight":"bold","color":c["text"]},
                            {"type":"text","text":"اضغط اسم اللعبة للبدء مباشرة","size":"xs","color":c["text2"],"wrap":True,"margin":"xs"}
                        ],"flex":1}
                    ],"margin":"md"},
                    {"type":"separator","margin":"md","color":c["border"]},
                    {"type":"box","layout":"horizontal","contents":[
                    ...
                    {"type":"box","layout":"horizontal","contents":[
                        ...
                        {"type":"box","layout":"vertical","contents":[
                            ...
                            {"type":"text","text":"9 ثيمات • ثيم [اسم الثيم]","size":"xs","color":c["text2"],"wrap":True,"margin":"xs"}
                        ],"flex":1}
                    ],"margin":"md"},
                    {"type":"separator","margin":"md","color":c["border"]},
                    {"type":"box","layout":"horizontal","contents":[
                        ...
                        {"type":"box","layout":"vertical","contents":[
                            ...
                            {"type":"text","text":"فريقين • فردي (في المجموعات)","size":"xs","color":c["text2"],"wrap":True,"margin":"xs"}
                        ],"flex":1}
                    ],"margin":"md"}
    ...
    body={
        ...
        "body":{
            ...
            "contents":[
                ...
                _separator_3d(theme),
                _3d_card([
                    {"type":"text","text":username[:30],"size":"xl","weight":"bold","color":c["text"],"align":"center","wrap":True},
                    {"type":"box","layout":"horizontal","contents":[
                        ...
                        ],"backgroundColor":c["card"],"cornerRadius":"16px","paddingAll":"16px","borderWidth":"1px","borderColor":c["border"],"margin":"md","flex":1,"offsetBottom":"4px"}
...
def build_leaderboard(top_users,theme=DEFAULT_THEME):
    ...
    for i,(name,pts,is_registered)in enumerate(top_users[:20],1):
        ...
        table_rows.append({
            ...
            "contents":[
                ...
                {"type":"separator","margin":"md","color":c["border"]},
                {"type":"text","text":status_icon,"size":"md","color":status_color,"flex":0,"align":"center"}
            ],
            "paddingAll":"12px","backgroundColor":row_bg,"cornerRadius":"12px",
    ...
    table_header={
        ...
        "contents":[
            ...
            {"type":"separator","margin":"md","color":c["button_text"]},
            {"type":"text","text":"حالة","size":"xs","weight":"bold","color":c["button_text"],"flex":0,"align":"center"}
        ],
    ...
    body_contents=[
        ...
        {"type":"text","text":"أفضل 20 لاعب","size":"sm","color":c["text2"],"align":"center","margin":"sm"},
        _separator_3d(theme),
        table_header,
        {"type":"box","layout":"vertical","contents":table_rows,"margin":"sm"},
        _separator_3d(theme),
        {"type":"text","text":"✓ نشط • ○ غير نشط","size":"xxs","color":c["text3"],"align":"center","wrap":True},
        {"type":"box","layout":"horizontal","spacing":"sm","margin":"lg","contents":[
            _premium_button("البداية","بداية","secondary",theme),
    ...
    body={
        ...
        "body":{
            ...
            "contents":[
                ...
                {"type":"text","text":f"الإجمالي: {total_points}","size":"sm","color":c["text2"],"align":"center","margin":"md"},
                _separator_3d(theme),
        ...
        "body":{
            ...
            "contents":[
                ...
                _3d_card([
                    ...
                    {"type":"text","text":f"الفائز: {winner}","size":"lg","weight":"bold","color":c["success"],"align":"center","margin":"lg"}
                ],theme,"18px"),
                {"type":"box","layout":"horizontal","spacing":"sm","margin":"xl","contents":[
