        ...
        "body": {
            ...
            "contents": [
                ...
                *theme_buttons,
                ...
                {
                    "type": "text",
                    "text": f"الوضع الحالي: {mode_label}",
                    "size": "md",
                    "weight": "bold",
                    "color": c["info"],
                    "align": "center",
                ...
                
                {
                    ...
                    "contents": [
                        ...
                        _premium_button("الصدMContinueارة", "صدارة", "secondary", theme)
]
},
            {
                "type": "box",
...
body = {
    ...
    "body": {
        ...
        "contents": [
            ...
            {
                "type": "text",
                "text": "مرتبة حسب الأكثر استخداماً",
                "size": "xs",
                "color": c["text3"],
                "align": "center"
            },
...
for i, (name, pts, is_registered) in enumerate(top_users[:20], 1):
    ...
    if i <= 3:
        rank_medals = ["🥇", "🥈", "🥉"]
        rank_text = rank_medals[i-1]
        rank_color = [c["primary"], c["accent"], c["secondary"]][i-1]
        row_bg = c["card"]
        border_width = "3px" if i == 1 else "2px"
    else:
        rank_text = str(i)
        rank_color = c["text2"]
        row_bg = c["card"]
    ...
    table_rows.append({
        ...
        "borderColor": rank_color if i <= 3 else c["border"],
        "margin": "xs"
    })
