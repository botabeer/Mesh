...
from linebot.v3.messaging import (
    FlexMessage, FlexContainer, TextMessage, QuickReply, QuickReplyItem, MessageAction
)
...
class UIBuilder:
    ...
    # -------------------- أزرار متكررة --------------------
    def _home_buttons(self, colors: Dict[str,str], theme: str) -> List[dict]:
        ...
        return [
            ...
            {"type": "box", "layout": "horizontal", "spacing": "sm", "margin": "sm", "contents": [
                {"type": "button", "style": "primary", "height": "sm", "color": colors["primary"], "action": {"type": "message", "label": "الألعاب", "text": "العاب"}},
    ...
    def _build_game_buttons(self, games: List[str], colors: Dict[str,str], primary=True) -> List[dict]:
        ...
        for i in range(0, len(games), 3):
            row = {"type": "box", "layout": "horizontal", "spacing": "sm", "margin": "xs" if i>0 else "md", "contents":[]}
                ...
                "contents": [
                    ...
                    {"type": "separator", "margin": "md", "color": c["border"]},
                    {
                        ...
                        "contents": [
                            ...
                            {"type": "text", "text": status, "size": "sm", "color": status_color, "align": "center", "margin": "sm"},
                    ...
                    *self._home_buttons(c, theme),
                    {"type": "separator", "margin": "md", "color": c["border"]},
                    {"type": "text", "text": self.config.RIGHTS, "size": "xxs", "color": c["text3"], "align": "center", "wrap": True, "margin": "sm"}
                ]
            }
        })
    ...
    def help_screen(self, theme: str) -> FlexMessage:
        ...
        commands = [
            ...
            ("أوامر الحساب", "• تسجيل - التسجيل (للنقاط)\n• انسحب - إلغاء التسجيل"),
        ...
        for title, text in commands:
            content.append({
                ...
                "contents":[
                    ...
                    {"type": "text", "text": text, "size": "sm", "color": c["text2"], "wrap": True, "margin": "sm"}
                ]
            })

        content.append({
            "type": "button", "style": "primary", "height": "sm", "color": c["primary"], "margin": "md",
        ...
        return self._create_flex("المساعدة", {
            "type": "bubble",
            "size": "mega",
            "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "backgroundColor": c["bg"],
                     "contents":[
        ...
        return self._create_flex("الألعاب", {
            ...
            "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "backgroundColor": c["bg"],
                     "contents":[
                         ...
                         *point_buttons,
                         {"type": "separator", "margin": "md", "color": c["border"]},
                         {"type": "text", "text": "ألعاب ترفيهية", "size": "md", "weight": "bold", "color": c["text"], "margin": "md"},
                         *fun_buttons,
                         {"type": "separator", "margin": "md", "color": c["border"]},
                         {"type": "box", "layout": "horizontal", "spacing": "sm", "margin": "md",
                          "contents":[
                              {"type": "button", "style": "primary", "height": "sm", "color": c["success"], "action": {"type": "message", "label": "تسجيل", "text": "تسجيل"}},
                              {"type": "button", "style": "secondary", "height": "sm", "action": {"type": "message", "label": "انسحب", "text": "انسحب"}},
                              {"type": "button", "style": "secondary", "height": "sm", "action": {"type": "message", "label": "ايقاف", "text": "ايقاف"}}
                          ]}
                     ]}
        })
        ...
        return self._create_flex("نقاطي", {
            ...
            "body":{"type":"box","layout":"vertical","paddingAll":"20px","backgroundColor":c["bg"],
                    "contents":[
                        ...
                        {"type":"separator","margin":"md","color":c["border"]},
                        {"type":"box","layout":"vertical","backgroundColor":c["card"],"cornerRadius":"16px","paddingAll":"16px","margin":"md",
                         "contents":[
                             {"type":"text","text":username[:30],"size":"lg","weight":"bold","color":c["text"],"align":"center"},
                             {"type":"text","text":"إجمالي النقاط","size":"sm","color":c["text2"],"align":"center","margin":"sm"},
                             {"type":"text","text":str(points),"size":"xxl","weight":"bold","color":c["primary"],"align":"center","margin":"xs"}
                         ]},
                        {"type":"box","layout":"vertical","backgroundColor":c["card"],"cornerRadius":"16px","paddingAll":"16px","margin":"sm",
                         "contents":[{"type":"text","text":"الألعاب الأكثر لعباً","size":"md","weight":"bold","color":c["text"],"align":"center"},
                                     {"type":"separator","margin":"sm","color":c["border"]},*rows]}
                    ]}
        })
    ...
    def leaderboard(self, top_users: List[tuple], theme: str) -> FlexMessage:
        ...
        for i, (name, pts, reg) in enumerate(top_users[:20], start=1):
            ...
            rows.append({
                "type":"box","layout":"horizontal","paddingAll":"10px","margin":"xs","backgroundColor":c["card"],"cornerRadius":"10px",
                "contents":[
                    {"type":"text","text":str(i),"size":"md","weight":"bold","color":rank_color,"flex":0},
                    {"type":"text","text":name[:20],"size":"sm","color":c["text"],"flex":3,"margin":"sm"},
