...
THEMES = {
    ...
    "رمادي": {
        ...
        "shadow_strong": "rgba(96,125,139,0.15)",
        "button_text": "#FFFFFF",
        "disabled": "#B0BEC5",
        "disabled_bg": "#ECEFF1",
        "gradient_start": "#607D8B",
        "gradient_end": "#90A4AE",
        "card_shadow": "0 4px 12px rgba(96,125,139,0.12)",
    ...
    "بني": {
        ...
        "shadow_strong": "rgba(139,111,71,0.15)",
        "button_text": "#FFFFFF",
        "disabled": "#BCAAA4",
        "disabled_bg": "#EFEBE9",
        "gradient_start": "#8B6F47",
        "gradient_end": "#C4A57B",
        "card_shadow": "0 4px 12px rgba(139,111,71,0.12)",
