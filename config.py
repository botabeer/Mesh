...
class Config:
    ...
    THEMES = {
        "light": {
            # ثيم فاتح - ألوان مريحة للعين
            "primary": "#2C3E50",           # رمادي مزرق داكن
            "secondary": "#7F8C8D",         # رمادي متوسط
            "success": "#34495E",           # رمادي داكن للنجاح
            "warning": "#5D6D7E",           # رمادي للتحذير
            "danger": "#4A5568",            # رمادي داكن للخطر
            "info": "#6B7280",              # رمادي للمعلومات
            
            # خلفيات
            "bg": "#FFFFFF",                # أبيض نقي
            "bg_secondary": "#F8F9FA",      # رمادي فاتح جداً
            "card": "#FFFFFF",              # أبيض للكروت
            "glass": "#F1F3F5",             # رمادي فاتح شفاف
            
            # نصوص
            "text": "#2C3E50",              # رمادي داكن للنصوص
            "text_secondary": "#5A6C7D",    # رمادي متوسط للثانوي
            "text_tertiary": "#95A5A6",     # رمادي فاتح للتفاصيل
            
            # حدود
            "border": "#E1E8ED",            # حدود رمادية فاتحة
        },
        "dark": {
