...
def is_rate_limited(user_id: str) -> bool:
    ...
    if len(user_rate_limit[user_id]) >= Config.RATE_LIMIT_MESSAGES:
...
def get_user_profile(line_api, user_id: str, src_type: str) -> dict:
    """الحصول على ملف المستخدم مع التخزين المؤقت"""
