...
# رسالة المساعدة - تصميم ناعم واحترافي
    ...
    return {
        ...
        "body": {
            ...
            "contents": [
                ...
                {
                    "type": "text",
                    "text": "• كل لعبة تتكون من 10 أسئلة\n• يتم الانتقال للسؤال التالي تلقائياً\n• الفائز يُعلن في نهاية اللعبة",
                    "size": "xs",
                    "color": "#8a8a8a",
                    "margin": "md",
                    "wrap": True
