                    ...
                    "contents": [
                        {
                            ...
                            "spacing": "sm",
                            "contents": [
                                theme_button("أبيض", "#4CAF50"),
                                theme_button("أسود", "#000000"),
                                theme_button("رمادي", "#999999")
                            ]
                        },
                        {
                            "type": "box",
                            ...
                            "spacing": "sm",
                            "contents": [
                                theme_button("أزرق", "#1976D2"),
                                theme_button("أخضر", "#4CAF50"),
                                theme_button("وردي", "#E91E63")
                            ]
                        }
                    ]
                },
                    ...
                    "contents": [
                        {
                            ...
                            "color": "#E0E0E0",
                            "height": "sm",
                            "action": {"type": "message", "label": "تقاطعي", "text": "تقاطعي"}
                        },
                        {
                            "type": "button",
                            "style": "secondary",
