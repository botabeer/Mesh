...
def get_winner_announcement(winner_name, winner_points, game_type, total_questions=5):
    """نافذة إعلان الفائز - تصميم Flex أنيق"""
    return {
        "type": "bubble",
        "size": "mega",
        "header": {
        ...
        "footer": {
            ...
            "contents": [
                ...
                {
                    "type": "text",
                    "text": "جرب لعبة أخرى من الأزرار أدناه",
                    "size": "xs",
                    "color": "#9a9a9a",
                    "align": "center",
                    "margin": "md"
        ...
        if game_id in active_games:
            ...
            try:
                ...
                if result:
                    ...
                    # تحديث نقاط اللاعب في اللعبة الحالية
                    if points > 0:
