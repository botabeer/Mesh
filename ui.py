...
class UI:
    ...
    @staticmethod
    def _footer():
        return "تم الانشاء بواسطة عبير الدوسري @ 2025"
        ...
        bubble = {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "text", "text": UI._footer(), "size": "xxs", "color": c["secondary"], "align": "center", "margin": "lg"}
                ],
            ...
            "footer": {
                ...
                "contents": [
                    {"type": "box", "layout": "horizontal", "contents": [
                        {"type": "button", "action": {"type": "message", "label": "تسجيل", "text": "تسجيل"}, "style": "secondary", "height": "sm"},
                    ...
                    {"type": "box", "layout": "horizontal", "contents": [
                        ...
                        {"type": "button", "action": {"type": "message", "label": "الصدارة", "text": "الصداره"}, "style": "secondary", "height": "sm"},
                    ...
                    {"type": "box", "layout": "horizontal", "contents": [
                        {"type": "button", "action": {"type": "message", "label": "مكافأة" if can_reward else "تم", "text": "مكافأة"}, "style": "primary" if can_reward else "secondary", "height": "sm"}
                    ], "margin": "sm"}
                ],
    ...
    def games_list(theme="light"):
        ...
        contents.extend([
            {"type": "separator", "margin": "lg", "color": c["border"]},
            {"type": "text", "text": UI._footer(), "size": "xxs", "color": c["secondary"], "align": "center", "margin": "md"}
        ])
    ...
    def achievements_list(user_achievements, theme="light"):
        ...
        contents = [
            {"type": "text", "text": "Bot Mesh", "size": "xxl", "weight": "bold", "color": c["text"], "align": "center"},
            {"type": "separator", "margin": "md", "color": c["border"]},
            {"type": "text", "text": "الانجازات", "size": "lg", "color": c["text"], "margin": "lg", "align": "center"}
        ]
        ...
        for achievement_id, achievement in Config.ACHIEVEMENTS.items():
            ...
            contents.append({
                "type": "box", "layout": "vertical",
                "contents": [
                    {"type": "text", "text": f"{'تم' if unlocked else 'لم يتم'} {achievement['name']}", "size": "md", "weight": "bold", "color": c["text"]},
        ...
        bubble = {
            ...
            "body": {
                ...
                "contents": [
                    {"type": "text", "text": "Bot Mesh", "size": "xxl", "weight": "bold", "color": c["text"], "align": "center"},
                    {"type": "separator", "margin": "md", "color": c["border"]},
                    {"type": "text", "text": "المساعدة", "size": "lg", "color": c["text"], "margin": "lg", "align": "center"},
                    {"type": "text", "text": help_text, "size": "sm", "color": c["text"], "wrap": True, "margin": "md"},
                    {"type": "separator", "margin": "lg", "color": c["border"]},
                    {"type": "text", "text": UI._footer(), "size": "xxs", "color": c["secondary"], "align": "center", "margin": "md"}
                ],
                "backgroundColor": c["bg"], "paddingAll": "20px"
