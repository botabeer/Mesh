...
class UI:
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "separator", "margin": "lg", "color": c["border"]},
                    {
                        ...
                        "layout": "horizontal",
                        "contents": [
                            {"type": "button", "action": {"type": "message", "label": "نقاطي", "text": "نقاطي"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1},
                            {"type": "button", "action": {"type": "message", "label": "الصدارة", "text": "الصدارة"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1},
                            {"type": "button", "action": {"type": "message", "label": "انجازات", "text": "انجازات"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1}
                        ],
                        "spacing": "sm",
                        "margin": "lg"
                    },
                    {
                        ...
                        "layout": "horizontal",
                        "contents": [
                            {"type": "button", "action": {"type": "message", "label": "تغيير", "text": "تغيير"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1},
                            {"type": "button", "action": {"type": "message", "label": "ثيم", "text": "ثيم"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1},
                            {"type": "button", "action": {"type": "message", "label": "انسحب", "text": "انسحب"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1}
                        ],
                        "spacing": "sm",
                        "margin": "sm"
                    },
                    {
                        ...
                        "layout": "horizontal",
                        "contents": [
                            {"type": "button", "action": {"type": "message", "label": "مساعدة", "text": "مساعدة"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1},
                            {"type": "button", "action": {"type": "message", "label": "العاب", "text": "العاب"}, "style": "primary", "color": c["button_primary"], "height": "sm", "flex": 1}
                        ],
                        "spacing": "sm",
                        "margin": "sm"
                    },
    ...
    def games_list(theme="light"):
        ...
        games = [
            ...
            ["مافيا", "مافيا"], ["توافق", "توافق"]
        ]
        
        contents = [
            {"type": "text", "text": "Bot Mesh", "size": "xxl", "weight": "bold", "color": c["primary"], "align": "center"},
            {"type": "separator", "margin": "lg", "color": c["border"]},
            {"type": "text", "text": "الالعاب", "size": "lg", "weight": "bold", "color": c["text"], "align": "center", "margin": "lg"}
        ]
        ...
        for i in range(0, len(games), 2):
            ...
            for j in range(2):
                if i + j < len(games):
                    cmd, label = games[i + j]
                    row.append({"type": "button", "action": {"type": "message", "label": label, "text": cmd}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1})
        ...
        bubble = {
            "type": "bubble",
            "size": "mega",
            "body": {"type": "box", "layout": "vertical", "contents": contents, "backgroundColor": c["bg"], "paddingAll": "24px"}
        }
                    ...
                    {"type": "text", "text": "احصائياتي", "size": "lg", "weight": "bold", "color": c["text"], "align": "center", "margin": "lg"},
                    {
                        ...
                        "contents": [
                            {"type": "box", "layout": "horizontal", "contents": [
                                {"type": "text", "text": "الاسم", "size": "sm", "color": c["text_secondary"]},
                                {"type": "text", "text": user['name'], "size": "sm", "color": c["text"], "align": "end"}
                            ]},
                            {"type": "box", "layout": "horizontal", "contents": [
                                {"type": "text", "text": "النقاط", "size": "sm", "color": c["text_secondary"]},
                                {"type": "text", "text": str(user['points']), "size": "sm", "color": c["text"], "align": "end"}
                            ], "margin": "sm"},
                            {"type": "box", "layout": "horizontal", "contents": [
                                {"type": "text", "text": "الالعاب", "size": "sm", "color": c["text_secondary"]},
                                {"type": "text", "text": str(user['games']), "size": "sm", "color": c["text"], "align": "end"}
                            ], "margin": "sm"},
                            {"type": "box", "layout": "horizontal", "contents": [
                                {"type": "text", "text": "الانتصارات", "size": "sm", "color": c["text_secondary"]},
                                {"type": "text", "text": str(user['wins']), "size": "sm", "color": c["text"], "align": "end"}
                            ], "margin": "sm"},
                            {"type": "box", "layout": "horizontal", "contents": [
                                {"type": "text", "text": "نسبة الفوز", "size": "sm", "color": c["text_secondary"]},
                                {"type": "text", "text": f"{win_rate:.1f}%", "size": "sm", "color": c["text"], "align": "end"}
                            ], "margin": "sm"},
                            {"type": "box", "layout": "horizontal", "contents": [
                                {"type": "text", "text": "السلسلة الحالية", "size": "sm", "color": c["text_secondary"]},
                                {"type": "text", "text": str(user['streak']), "size": "sm", "color": c["text"], "align": "end"}
                            ], "margin": "sm"},
                            {"type": "box", "layout": "horizontal", "contents": [
                                {"type": "text", "text": "افضل سلسلة", "size": "sm", "color": c["text_secondary"]},
                                {"type": "text", "text": str(user['best_streak']), "size": "sm", "color": c["text"], "align": "end"}
                            ], "margin": "sm"}
                        ],
                        "margin": "lg",
                        "paddingAll": "15px",
    ...
    def leaderboard(leaders, theme="light"):
        ...
        contents = [
            {"type": "text", "text": "Bot Mesh", "size": "xxl", "weight": "bold", "color": c["primary"], "align": "center"},
            {"type": "separator", "margin": "lg", "color": c["border"]},
            {"type": "text", "text": "لوحة الصدارة", "size": "lg", "weight": "bold", "color": c["text"], "align": "center", "margin": "lg"}
        ]
        ...
        for idx, leader in enumerate(leaders[:10]):
            ...
            contents.append({
                ...
                "layout": "horizontal",
                "contents": [
                    {"type": "text", "text": f"{rank}", "size": "lg" if idx < 3 else "md", "weight": "bold" if idx < 3 else "regular", "color": c["text"], "flex": 0, "align": "center"},
                    {"type": "text", "text": leader['name'], "size": "md", "color": c["text"], "flex": 1, "margin": "md"},
    ...
    def achievements_list(user_achievements, theme="light"):
        ...
        contents = [
            {"type": "text", "text": "Bot Mesh", "size": "xxl", "weight": "bold", "color": c["primary"], "align": "center"},
            {"type": "separator", "margin": "lg", "color": c["border"]},
            {"type": "text", "text": "الانجازات", "size": "lg", "weight": "bold", "color": c["text"], "align": "center", "margin": "lg"}
        ]
        
        for group_name, achievement_ids in achievements_groups:
            contents.append({"type": "text", "text": group_name, "size": "md", "weight": "bold", "color": c["text"], "margin": "lg"})
                    ...
                    "contents": [
                        {
                            ...
                            "layout": "vertical",
                            "contents": [
                                {"type": "text", "text": achievement['name'], "size": "sm", "weight": "bold", "color": c["text"]},
                                {"type": "text", "text": achievement['desc'], "size": "xs", "color": c["text_secondary"], "wrap": True}
                            ],
                            "flex": 1
                        },
                        {"type": "text", "text": f"+{achievement['points']}" if unlocked else "مقفل", "size": "xs", "color": c["text"] if unlocked else c["text_tertiary"], "flex": 0, "align": "center"}
                    ],
                    "paddingAll": "10px",
        ...
        bubble = {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "text", "text": "انجاز جديد", "size": "lg", "weight": "bold", "color": c["text"], "margin": "lg", "align": "center"},
                    {"type": "text", "text": achievement['name'], "size": "md", "weight": "bold", "color": c["text"], "margin": "md", "align": "center"},
                    {"type": "text", "text": achievement['desc'], "size": "sm", "color": c["text_secondary"], "wrap": True, "margin": "sm", "align": "center"},
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "text", "text": game_name, "size": "lg", "weight": "bold", "color": c["text"], "align": "center", "margin": "lg"},
                    {
                        ...
                        "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": status, "size": "xl", "weight": "bold", "color": c["text"], "align": "center"},
                            {"type": "text", "text": f"{score}/{total}", "size": "lg", "color": c["text_secondary"], "align": "center", "margin": "sm"},
                            {"type": "text", "text": f"النقاط: +{score}", "size": "md", "color": c["text_tertiary"], "align": "center", "margin": "md"}
                        ],
                        "margin": "lg",
                        "paddingAll": "20px",
                        "backgroundColor": c["card_secondary"],
                    ...
                    {"type": "separator", "margin": "lg", "color": c["border"]},
                    {
                        ...
                        "layout": "horizontal",
                        "contents": [
                            {"type": "button", "action": {"type": "message", "label": "بداية", "text": "بداية"}, "style": "secondary", "color": c["button_secondary"], "height": "sm", "flex": 1},
                            {"type": "button", "action": {"type": "message", "label": "العاب", "text": "العاب"}, "style": "primary", "color": c["button_primary"], "height": "sm", "flex": 1}
                        ],
                        "spacing": "sm",
                        "margin": "lg"
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "text", "text": "المساعدة", "size": "lg", "weight": "bold", "color": c["text"], "align": "center", "margin": "lg"},
                    {
                        ...
                        "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": "الاوامر الاساسية", "size": "md", "weight": "bold", "color": c["text"]},
                            {"type": "text", "text": "تسجيل - التسجيل في البوت\nبداية - القائمة الرئيسية\nالعاب - قائمة الالعاب\nنقاطي - احصائياتك\nالصدارة - المتصدرين\nانجازات - انجازاتك\nمكافأة - مكافأة يومية\nتغيير - تغيير الاسم\nثيم - تغيير الثيم\nايقاف - ايقاف اللعبة\nانسحب - الانسحاب", "size": "sm", "color": c["text_secondary"], "wrap": True, "margin": "sm"}
                        ],
                        "margin": "lg",
                        "paddingAll": "12px",
                        "backgroundColor": c["card_secondary"],
                    ...
                    },
                    {
                        ...
                        "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": "الاوامر الترفيهية", "size": "md", "weight": "bold", "color": c["text"]},
                            {"type": "text", "text": "سؤال - سؤال عشوائي\nمنشن - منشن عشوائي\nتحدي - تحدي عشوائي\nاعتراف - اعتراف عشوائي\nشخصية - سؤال شخصي\nحكمة - حكمة عشوائية\nموقف - موقف افتراضي", "size": "sm", "color": c["text_secondary"], "wrap": True, "margin": "sm"}
                        ],
                        "margin": "md",
                        "paddingAll": "12px",
                        "backgroundColor": c["card_secondary"],
                    ...
                    },
                    {
                        ...
                        "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": "اوامر اللعب", "size": "md", "weight": "bold", "color": c["text"]},
                            {"type": "text", "text": "لمح - الحصول على تلميح\nجاوب - كشف الاجابة\nايقاف - ايقاف اللعبة", "size": "sm", "color": c["text_secondary"], "wrap": True, "margin": "sm"}
                        ],
                        "margin": "md",
                        "paddingAll": "12px",
                        "backgroundColor": c["card_secondary"],
