...
class ScrambleGame(BaseGame):
    def __init__(self, db, theme: str = "light"):
        ...
        self.words = [
            "مدرسه", "كتاب", "قلم", "باب", "نافذه", "طاوله", "كرسي", "سياره",
            "طائره", "قطار", "تفاحه", "موز", "برتقال", "عنب", "بطيخ", "شمس",
            "قمر", "نجمه", "سماء", "بحر", "جبل", "نهر", "اسد", "نمر", "فيل",
            "زرافه", "حصان", "ورد", "شجره", "زهره", "منزل", "مسجد", "حديقه"
        ]
