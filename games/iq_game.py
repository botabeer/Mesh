...
class IqGame(BaseGame):
    ...
    def __init__(self, line_bot_api):
        ...
        self.riddles = [
            ...
            {"q": "له رأس ولكن لا عين له", "a": ["الدبوس", "المسمار", "الإبرة", "دبوس", "مسمار"]},
            ...
            {"q": "ما هو الشيء الذي له أربع أرجل ولا يمشي", "a": ["الكرسي", "كرسي", "الطاولة"]},
            {"q": "يصعد ولا ينزل", "a": ["العمر", "عمر"]}
        ]
    ...
    def get_question(self):
        ...
        return self.build_question_flex(riddle['q'], None)
