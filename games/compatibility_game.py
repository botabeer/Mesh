...
class CompatibilityGame(BaseGame):
        ...
        bubble = {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {
                        "type": "text", "text": "احسب نسبة التوافق بين شخصين",
                        "size": "md", "color": c["text"],
                        "align": "center", "margin": "lg"
                    },
                    {
                        "type": "text", "text": "ادخل اسمين بينهما 'و'",
                    ...
                    },
                    {
                        ...
                        "contents": [{
                            ...
                            "size": "xs", "color": c["text3"], "align": "center"
                        }],
                    ...
                    {"type": "separator", "margin": "lg", "color": c["border"]},
                    {
                        "type": "text", "text": "ملاحظة: اللعبة للترفيه فقط",
            ...
            "footer": {
                ...
                "contents": [{
                    ...
                    "style": "secondary", "height": "sm", "color": self.BUTTON_COLOR
                }]
            }
        }
    ...
    def check_answer(self, user_answer, user_id, display_name):
        ...
        if not self.is_valid_text(name1) or not self.is_valid_text(name2):
            return {"response": TextMessage(text="غير مسموح بالرموز او الارقام"), "points": 0}
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "separator", "margin": "lg", "color": c["border"]},
                    {
                        ...
                        "cornerRadius": "12px", "paddingAll": "16px", "spacing": "md",
                        "contents": [
                            {"type": "text", "text": name1, "size": "lg",
                             "color": c["text"], "align": "center", "weight": "bold", "flex": 3},
                            {"type": "text", "text": "و", "size": "md",
                             "color": c["text2"], "align": "center", "flex": 1},
                            {"type": "text", "text": name2, "size": "lg",
                             "color": c["text"], "align": "center", "weight": "bold", "flex": 3}
                        ]
                    },
                    {
                        ...
                        "contents": [
                            ...
                            {
                                "type": "box", "layout": "horizontal",
                                "margin": "sm", "height": "8px",
                                "backgroundColor": c["border"], "cornerRadius": "4px",
                                "contents": [{
                                    "type": "box", "layout": "vertical",
                                    "backgroundColor": color,
                                    "width": f"{percentage}%",
                                    "height": "8px", "cornerRadius": "4px", "contents": []
                                }]
                            }
                        ]
                    },
