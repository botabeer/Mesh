...
def get_question(self):
    ...
    if not self.team_mode:
        footer_buttons = [
            ...
            {"type":"text","text":"💡 لمح | جاوب","size":"xs","color":colors["text2"],"align":"center","wrap":True,"margin":"lg"}
        ]
...
def check_answer(self, user_answer: str, user_id: str, display_name: str):
    ...
    if self.team_mode:
        ...
        if normalized == normalized_correct or normalized in normalized_correct or normalized_correct in normalized:
            ...
            return {'message':f"✅ صحيح\n🎤 {self.current_answer}\n+10 نقطة",'response':self.get_question(),'points':10}
