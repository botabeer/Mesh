"""
لعبة تخمين المغني من كلمات الأغنية - Fixed Version
"""
...
class SongGame(BaseGame):
    ...
    def __init__(self, line_bot_api):
        ...
        self.songs = [
            ...
            {"artist": "نانسي عجرم", "title": "يا بنات",
             "lyrics": "يا بنات يا بنات", "nationality": "لبنانية"},
            ...
            {"artist": "تامر حسني", "title": "كل الحياة",
             "lyrics": "حبيبي يا كل الحياة اوعدني تبقى معايا", "nationality": "مصري"},
            {"artist": "وائل كفوري", "title": "قلبي بيسألني",
             "lyrics": "قلبي بيسألني عنك دخلك طمني وينك", "nationality": "لبناني"},
            {"artist": "عايض", "title": "كيف أبين لك",
             "lyrics": "كيف أبيّن لك شعوري دون ما أحكي", "nationality": "سعودي"},
            {"artist": "عايض", "title": "اسخر لك غلا",
             "lyrics": "اسخر لك غلا وتشوفني مقصر", "nationality": "سعودي"},
            {"artist": "عبدالمجيد عبدالله", "title": "رحت عني",
             "lyrics": "رحت عني ما قويت جيت لك لاتردني", "nationality": "سعودي"},
            {"artist": "عبادي الجوهر", "title": "خذني من ليلي",
             "lyrics": "خذني من ليلي لليلك", "nationality": "سعودي"},
            {"artist": "راشد الماجد", "title": "مخنوق",
             "lyrics": "تدري كثر ماني من البعد مخنوق", "nationality": "سعودي"},
            {"artist": "عباس ابراهيم", "title": "انسى هالعالم",
             "lyrics": "انسى هالعالم ولو هم يزعلون", "nationality": "سعودي"},
            ...
            {"artist": "نوال الكويتية", "title": "خلنا مني",
             "lyrics": "خلنا مني طمني عليك", "nationality": "كويتية"},
            {"artist": "عبدالمجيد عبدالله", "title": "أحبك ليه",
             "lyrics": "أحبك ليه أنا مدري", "nationality": "سعودي"},
            {"artist": "ماجد المهندس", "title": "أمر الله أقوى",
             "lyrics": "أمر الله أقوى أحبك والعقل واعي", "nationality": "عراقي"},
            {"artist": "راشد الماجد", "title": "الحب يتعب",
             "lyrics": "الحب يتعب من يدله والله في حبه بلاني", "nationality": "سعودي"},
            {"artist": "وليد الشامي", "title": "شغل عقلي",
             "lyrics": "محد غيرك شغل عقلي شغل بالي", "nationality": "عراقي"},
            {"artist": "أصالة نصري", "title": "مر الحقيقة",
             "lyrics": "نكتشف مر الحقيقة بعد ما يفوت الأوان", "nationality": "سورية"},
            {"artist": "أميمة طالب", "title": "اخباري تمام",
             "lyrics": "يا هي توجع كذبة اخباري تمام", "nationality": "سعودية"},
            {"artist": "عبدالمجيد عبدالله", "title": "لقيتك عشان تضيع",
             "lyrics": "احس اني لقيتك بس عشان تضيع مني", "nationality": "سعودي"},
        ]
    ...
    def get_hint(self):
        """الحصول على تلميح"""
        song = self.songs[self.current_question % len(self.songs)]
        female_nationalities = ["لبنانية", "سورية", "كويتية", "سعودية", "مصرية"]
        gender = "مغنية" if song["nationality"] in female_nationalities else "مغني"
