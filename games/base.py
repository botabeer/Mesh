    ...
    def build_question_flex(self, question_text, hint=None):
        ...
        contents = [
            ...
            {"type": "box", "layout": "horizontal", "margin": "lg", "contents": [
                ...
                {"type": "box", "layout": "vertical", "width": "60px", "backgroundColor": c["card_secondary"], "cornerRadius": "12px", "paddingAll": "8px", "contents": [
        ...
        if hint:
            contents.append({"type": "text", "text": self._safe_text(hint), "size": "xs", "color": c["text_tertiary"], "align": "center", "margin": "md"})
        contents.append({"type": "box", "layout": "vertical", "backgroundColor": c["card"], "cornerRadius": "12px", "paddingAll": "24px", "margin": "lg", "contents": [
            {"type": "text", "text": self._safe_text(question_text), "wrap": True, "align": "center", "size": "lg", "weight": "bold", "color": c["text"]}
        ]})
        button_contents = []
        if self.supports_hint:
            button_contents.append({"type": "button", "action": {"type": "message", "label": "لمح", "text": "لمح"}, "style": "secondary", "color": c["button"], "height": "sm", "flex": 1})
        if self.supports_reveal:
            button_contents.append({"type": "button", "action": {"type": "message", "label": "جاوب", "text": "جاوب"}, "style": "secondary", "color": c["button"], "height": "sm", "flex": 1})
        button_contents.append({"type": "button", "action": {"type": "message", "label": "ايقاف", "text": "ايقاف"}, "style": "secondary", "color": c["button"], "height": "sm", "flex": 1})
        contents.append({"type": "separator", "margin": "lg", "color": c["border"]})
        contents.append({"type": "box", "layout": "horizontal", "contents": button_contents, "spacing": "sm", "margin": "md"})
        contents.append({"type": "text", "text": "Bot Mesh | 2025", "size": "xxs", "color": c["text_secondary"], "align": "center", "margin": "lg"})
